...
class _DropboxTransport(object):
    ...
    def refresh_access_token(self, host=API_HOST, scope=None):
        ...
        print('New token: ', self._oauth2_access_token)
        print('Will expired at ', self._oauth2_access_token_expiration)

        with open('C:/Users/lukin2dmaterials/miniconda3/envs/NV_control/B00_codes/currentDropboxToken.txt', 'w') as f:
            f.write('New token: \n')
            f.write(self._oauth2_access_token + '\n')
            f.write('Will expired at (UTC): \n')
            f.write(str(self._oauth2_access_token_expiration))
            f.close() 
