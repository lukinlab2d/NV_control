...
class Velocity():
    def __init__(self, name='Velocity_6304H', velNum=2, settings=None, **kwargs) -> None:
...
if __name__ == '__main__':
    vel = Velocity()
    vel.set_scan_limits(635.35,640.6)
    vel.set_scan_speeds(0.1,0.1)
    # vel.reset_scan()
    # vel.start_scan()
    # vel.reset_scan()
    vel.set_track()
