...
# def noise(ch1data,ch2data,noise_duration,dutycycle,amp):
#     m1=int(dutycycle*noise_duration)
#     rnd_arr = random_array(noise_duration,m1=m1)

#     ch1data = np.concatenate((ch1data, np.zeros(noise_duration, dtype=np.int16)))
#     ch2data = np.concatenate((ch2data, rnd_arr*int(amp*32767)))
#     return(ch1data,ch2data)

def noise(ch1data,ch2data,noise_duration,rnd_arr,amp):
    ch1data = np.concatenate((ch1data, np.zeros(noise_duration, dtype=np.int16)))
    ch2data = np.concatenate((ch2data, rnd_arr*int(amp*32767)))
    return(ch1data,ch2data)
...
class SDG6022X():
    ...
    def upload_waveform(self, freq, ch1data, ch2data):
        if self.srate is None:
            ...
            self.SDG.write("C1:WVDT WVNM,wave1" + ",WAVEDATA,%s" % (ch1data), encoding='latin1')
            self.SDG.write("C1:ARWV NAME,wave1")
            self.SDG.write("C2:WVDT WVNM,wave2" + ",WAVEDATA,%s" % (ch2data), encoding='latin1')
            self.SDG.write("C2:ARWV NAME,wave2")
    ...
    def send_T1_seq(self, pitime, buffer,pi_pulse_bf_read=None,
                        rest_btwn_pi_and_pi_bf_readsig=0,rest_btwn_pi_bf_readsig_and_pi_bf_readref=0,sleepTime=1):
        if pi_pulse_bf_read==None or pi_pulse_bf_read=='plus':
        ...
        elif pi_pulse_bf_read=='minus':
            psperiod = 2*buffer + 3*pitime + rest_btwn_pi_and_pi_bf_readsig + rest_btwn_pi_bf_readsig_and_pi_bf_readref
            ...
            ch1data, ch2data = pix(ch1data, ch2data, int(pitime/factor))
            ch1data, ch2data = rest(ch1data, ch2data, int(rest_btwn_pi_and_pi_bf_readsig/factor))
            ch1data, ch2data = pix(ch1data, ch2data, int(pitime/factor))
            ch1data, ch2data = rest(ch1data, ch2data, int(rest_btwn_pi_bf_readsig_and_pi_bf_readref/factor))
            ch1data, ch2data = pix(ch1data, ch2data, int(pitime/factor))
            ch1data, ch2data = rest(ch1data, ch2data, int(buffer/factor))
    ...
    def send_T2E_seq(self, pi_2time, pitime, tau, buffer, sig_to_ref_wait, 
                     special_I=0, special_Q=32767,sleepTime=0):
        ...
        if self.srate is not None:
            ...
            pitime = int(pitime/factor); pi_2time = int(pi_2time/factor)
            tau = int(tau/factor); buffer = int(buffer/factor); sig_to_ref_wait = int(sig_to_ref_wait/factor)
        else:
            print('DDS mode')
        ...
        if self.srate is not None:
            ch1plot = np.repeat(ch1plot,factor)
            ch2plot = np.repeat(ch2plot,factor)
    ...
    def send_SCCRRPhotonStatIrber_seq(self, MWmix_duration, buffer,
                                      sig_to_ref_wait, pitime, pi_to_MWmix_wait,
                                      shift_MW=0,sleepTime=6,amp_MW_mix=1,pi_pulse_bf_read=None,
                                      rest_btwn_pi_and_pi_bf_readsig=0,
                                      rest_btwn_pi_bf_readsig_and_MWmix=0):
        ...
        if pi_pulse_bf_read != 'minus':   
            ...
            new_sig2refwait = sig_to_ref_wait - rest_btwn_pi_bf_readsig_and_MWmix - pitime

            ch1data, ch2data = rest(ch1data, ch2data, int((buffer+shift_MW) / factor))
            ch1data, ch2data = piy(ch1data, ch2data, int(pitime/factor))
            ch1data, ch2data = rest(ch1data, ch2data, int(rest_btwn_pi_and_pi_bf_readsig/factor))
            ch1data, ch2data = piy(ch1data, ch2data, int(pitime/factor))
            ch1data, ch2data = rest(ch1data, ch2data, int(rest_btwn_pi_bf_readsig_and_MWmix/factor))
            ch1data, ch2data = piy(ch1data, ch2data, int(MWmix_duration/factor), amp=int(amp_MW_mix*32767))
            ch1data, ch2data = rest(ch1data, ch2data, int(new_sig2refwait/factor))
            ch1data, ch2data = piy(ch1data, ch2data, int(pitime/factor))
            ch1data, ch2data = rest(ch1data, ch2data, int(rest_btwn_pi_bf_readsig_and_MWmix/factor))
            ch1data, ch2data = piy(ch1data, ch2data, int(MWmix_duration/factor), amp=int(amp_MW_mix*32767))
            ch1data, ch2data = rest(ch1data, ch2data, int(buffer/factor))
    ...
    def send_SCCRRPhotonStatIrberSameFreq_seq(self, MWmix_duration, buffer,
                                      sig_to_ref_wait, pitime, pi_to_MWmix_wait,
                                      shift_MW=0,sleepTime=6,amp_MW_mix=1,pi_pulse_bf_read=None,
                                      rest_btwn_pi_and_pi_bf_readsig=0,
                                      rest_btwn_pi_bf_readsig_and_MWmix=0):
    ...
    def send_T1SCCRRnoise_seq(self, MWmix_duration, buffer,
                                      sig_to_ref_wait, pitime, pi_to_MWmix_wait,
                                      shift_MW=0,sleepTime=6,amp_MW_mix=1,ifAntiCorrel=0,AWGnum=0):
        psperiod = 2*buffer + shift_MW+pitime + pi_to_MWmix_wait + 2*MWmix_duration + sig_to_ref_wait
        freq = 1e9/psperiod # doesn't mean anything
        ch1data = np.array([], dtype=np.int16) 
        ch2data = np.array([], dtype=np.int16)
    ...
    def send_T1SCCRRnoiseAWG_seq(self, MWmix_duration, buffer,
                                      sig_to_ref_wait, pitime, pi_to_MWmix_wait,
                                      pi_to_noise_wait, noise_duration, noise_to_MWmix_wait,
                                      rnd_arr,amp_noise=0,
                                      shift_MW=0,sleepTime=6,amp_MW_mix=1):
        psperiod = 2*buffer + shift_MW+pitime + pi_to_MWmix_wait + 2*MWmix_duration + sig_to_ref_wait
        freq = 1e9/psperiod # doesn't mean anything
        ch1data = np.array([], dtype=np.int16) 
        ch2data = np.array([], dtype=np.int16)
        ...
        ch1data, ch2data = rest(ch1data, ch2data, int(sig_to_ref_wait/factor))
        ch1data, ch2data = piy(ch1data, ch2data, int(pitime/factor))
        ch1data, ch2data = rest(ch1data, ch2data, int(pi_to_noise_wait/factor))
        ch1data, ch2data = noise(ch1data,ch2data, int(noise_duration/factor), 
                                 rnd_arr=rnd_arr, amp=amp_noise)
        ch1data, ch2data = rest(ch1data, ch2data, int(noise_to_MWmix_wait/factor))
        ch1data, ch2data = piy(ch1data, ch2data, int(MWmix_duration/factor), amp=int(amp_MW_mix*32767))
        ch1data, ch2data = rest(ch1data, ch2data, int(buffer/factor))
    ...
    def send_T1SCCRRSameFreqNoise_seq(self, MWmix_duration, buffer,
                                      sig_to_ref_wait, pitime, pi_to_MWmix_wait,
                                      shift_MW=0,sleepTime=6,amp_MW_mix=1,initStateSig=1,initStateRef=1):
        psperiod = 2*buffer + shift_MW+pitime + pi_to_MWmix_wait + 2*MWmix_duration + sig_to_ref_wait
        freq = 1e9/psperiod # doesn't mean anything
        ch1data = np.array([], dtype=np.int16) 
        ch2data = np.array([], dtype=np.int16)
    ...
    def send_XY8SCCRRIrber_seq(self, MWmix_duration, buffer, 
        ...
        psperiod = 2*buffer + 2*(pitime + rest_after_first_pulse + shift_MW) + 2*(2*pi_2time + numxy8*tau*8 + numxy8*pitime*8 - 0*pi_2time) + 2*pulse_to_MWmix_wait + 2*MWmix_duration + MWmix_to_pulseRef_wait
        freq = 1e9/psperiod
        ch1data = np.array([], dtype=np.int16)
        ch2data = np.array([], dtype=np.int16)
        ...
        ch1data, ch2data = pi_2x(ch1data, ch2data, pi_2time)
        ch1data, ch2data = rest(ch1data, ch2data, int(tau/2-0*pi_2time/2))
        ...
        ch1data, ch2data = rest(ch1data, ch2data, int(tau/2+tauExtra-0*pi_2time/2))
        ...
        if ifJustRef_CorrACorr==0 or ifJustRef_CorrACorr==AWGnum+2:    # flip the last pihalf pulse as usual
            if mode == 0:
                ch1data, ch2data = min_pi_2x(ch1data, ch2data, pi_2time)
            elif mode == 1:
                ch1data, ch2data = pi_2special(ch1data, ch2data, pi_2time, -1*special_I, -1*special_Q)
    ...
    def send_XY8DrivenCorrSCCRRIrber_seq(self, MWmix_duration, buffer, 
        ...
        psperiod = 2*buffer + 2*(pitime + rest_after_first_pulse + shift_MW) + 2*(2*pi_2time + numxy8*tau*8 + numxy8*pitime*8 + XY8_to_DC_delay - pi_2time) + (pulse_time+pulse_time_ref) + 2*pulse_to_MWmix_wait + 2*MWmix_duration + MWmix_to_pulseRef_wait
        freq = 1e9/psperiod
        ch1data = np.array([], dtype=np.int16)
        ch2data = np.array([], dtype=np.int16)
        ...
        ch1data, ch2data = pi_2x(ch1data, ch2data, pi_2time)
        ch1data, ch2data = rest(ch1data, ch2data, int(tau/2-pi_2time/2))
        ...
        ch1data, ch2data = rest(ch1data, ch2data, int(tau/2+tauExtra-pi_2time/2))
    ...
    def send_AutoCorrXY8SCCRRIrber_seq(self, MWmix_duration, buffer, 
        ...
        psperiod = 2*buffer + 2*(pitime + rest_after_first_pulse + shift_MW + 2*(2*pi_2time + numxy8*tau*8 + numxy8*pitime*8 + tauExtra - pi_2time) + tcorr + pulse_to_MWmix_wait + MWmix_duration) + MWmix_to_pulseRef_wait
        freq = 1e9/psperiod
    ...
    def send_fastRabi_seq(self, pulse_width, buffer,amp_MW_mix=1):
        ...
        ch1data, ch2data = piy(ch1data, ch2data, pulse_width, amp=int(amp_MW_mix*32767))
    ...
    def send_XY8_seq(self, pitime, pi_2time, tau, numxy8, buffer, sig_to_ref_wait, mode,
                     ...
                     ifAntiCorrel=0,AWGnum=0,ifJustRef_CorrACorr=0,rest_after_first_pulse=80,
                     last_pi_2time=0,special_I_antiCorrPulse=0, special_Q_antiCorrPulse=32767,
                     tauExtra=0,sleepTime=0): # mode = 0: cos mag, mode = 1: sin mag
        
        if last_pi_2time==0: last_pi_2time=pi_2time
        psperiod = 2*buffer + 2*(pitime + rest_after_first_pulse + (last_pi_2time + pi_2time) + numxy8*tau*8 + numxy8*pitime*8 - pi_2time) + sig_to_ref_wait
        freq = 1e9/psperiod
        ...
        if self.srate is not None:
            ...
            pitime = int(pitime/factor); pi_2time = int(pi_2time/factor)
            tau = int(tau/factor); buffer = int(buffer/factor); sig_to_ref_wait = int(sig_to_ref_wait/factor)
            rest_after_first_pulse = int(rest_after_first_pulse/factor)
            last_pi_2time = int(last_pi_2time/factor); tauExtra = int(tauExtra/factor)
        else:
            print('DDS mode')
        ...
        if ifAntiCorrel==1:
            ...
            ch1data, ch2data = rest(ch1data, ch2data, pitime)
        ch1data, ch2data = rest(ch1data, ch2data, rest_after_first_pulse)
    ...
    def send_XY84point_seq(self, pitime, pi_2time, tau, numxy8, buffer, sig_to_ref_wait,
                     special_I=0, special_Q=32767,
                     last_pi_2time=0,
                     tauExtra=0,sleepTime=0):
        
        if last_pi_2time==0: last_pi_2time=pi_2time
        psperiod = 2*buffer + 4*((last_pi_2time + pi_2time) + numxy8*tau*8 + numxy8*pitime*8 - pi_2time) + 3*sig_to_ref_wait
        freq = 1e9/psperiod
        ...
        ch1data, ch2data = rest(ch1data, ch2data, int(tau/2+tauExtra-pi_2time/2))
        # ch1data, ch2data = min_pi_2x(ch1data, ch2data, last_pi_2time)
        I = round(32767*np.cos(0)) # phi_IQ in radian = 0 means x-axis
        Q = round(32767*np.sin(0))
        # ch1data, ch2data = pi_2x(ch1data, ch2data, last_pi_2time)
        ch1data, ch2data = pi_2special(ch1data, ch2data, last_pi_2time, -1*I, -1*Q)
        ch1data, ch2data = rest(ch1data, ch2data, sig_to_ref_wait)
    ...
    def send_AutoCorrXY8_seq(self, pitime, pi_2time, tau, numxy8, buffer, sig_to_ref_wait, mode,
                     ...
                     ifAntiCorrel=0,AWGnum=0,ifJustRef_CorrACorr=0,rest_after_first_pulse=80,
                     last_pi_2time=0,special_I_antiCorrPulse=0, special_Q_antiCorrPulse=32767,
                     tauExtra=0,tcorr=80,sleepTime=0): # mode = 0: cos mag, mode = 1: sin mag
        
        if last_pi_2time==0: last_pi_2time=pi_2time
        psperiod = 2*buffer + 2*(pitime + rest_after_first_pulse + 2*(last_pi_2time + pi_2time + numxy8*tau*8 + numxy8*pitime*8 + tauExtra - pi_2time)+tcorr) + sig_to_ref_wait
        freq = 1e9/psperiod
        ...
        if self.srate is not None:
            ...
            tau = int(tau/factor); buffer = int(buffer/factor); sig_to_ref_wait = int(sig_to_ref_wait/factor)
            rest_after_first_pulse = int(rest_after_first_pulse/factor)
            last_pi_2time = int(last_pi_2time/factor); tauExtra = int(tauExtra/factor); tcorr = int(tcorr/factor)
        else:
            print('DDS mode')
