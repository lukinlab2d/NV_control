...
class Counter(Instrument):
    ...
    def __init__(self, name: str, device_name: str, counter_channel: Dict[str, int], clock_channel: Dict[str, int],
        ...
        self.task1 = nidaqmx.Task(); self.counter_output_task = nidaqmx.Task()
        self.counter_output_task.co_channels.add_co_pulse_chan_freq(
        ...
        # cfg implict timing
        self.counter_output_task.timing.cfg_implicit_timing(
            sample_mode = AcquisitionType.CONTINUOUS,
            samps_per_chan = self.samples_per_channel,
            )

        # adding count egdes chan
        self.task1.ci_channels.add_ci_count_edges_chan(
        ...
        self.task1.timing.cfg_samp_clk_timing(
        ...
        global task1; task1 = self.task1
        global counter_output_task; counter_output_task = self.counter_output_task
