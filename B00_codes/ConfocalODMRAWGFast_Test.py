...
for i in range(1):
    xArray = np.linspace(-0.65,0.15,21); yArray = np.linspace(0,0.8,21); ifDifferential = 0
    
    a1 = 2829.8e6; b1 = a1+20e6; num_sweep_points = 21
    f1 = np.linspace(a1, b1, num_sweep_points)
    a2 = 2908.3e6; b2 = a2+20e6; num_sweep_points = 21
    ...
    num_loops                    = int(3e5); settleTime             = 2e9
    laser_init_delay             = 0;        laser_init_duration    = 0
    pitime                       = 80;       laser_to_AWG_delay     = 0; pitime2=0
    ...
    xref_pitime                  = -0.65;    pi_incr_factor         = 14/0.8; pi_incr_factor2=0 #ns/Vx
