...
for iii in range(int(reps)):
    ...
    tausArray = np.round(np.logspace(np.log10(3e3),np.log10(30e6),16),-2) # sweep pi_to_ion_delay
    tausArray[-1] = 25e6
    ##############################################################################################################
    if True:
         # NV1
    ...
    pi_to_ion_delay              = 2e2;       pi_to_hilo_extra_delay    = 2.8e3
...
#         AG.disable_RFOutput(channel=2)
    ...
    # RRLaser2Switch_delay         = laserSwitch_delay_directory.get(laserRead2_channel, 0)        
    # laser_to_pi_delay            = laserSwitch_delay_directory.get(laserInit_channel, 0) + 5e2
    # pi_to_ion_delay              = 5e2;       pi_to_hilo_extra_delay    = 2.9e3
    # ion_duration                 = 8e3;       ion_duration2             = 8e3
    # ion_to_read_delay            = 3e3;       DAQ_duration              = 3e6
    # DAQ_to_laser_off_delay       = 1e2;       shift_btwn_2NV_read       = DAQ_duration+3e3
    # AWG_buffer                   = 40;        AWG_output_delay          = 1450
    ...
    # laserRead_to_MWmix           = 0;         shift_btwn_2NV_MW         = 80
    # spinInit_RR_duration         = 0;         spinInit_RR_to_pi_delay   = 0*(RRLaserSwitch_delay+200)
    # spinInit_pi_to_RR_delay      = 0;         pi_pulse_bf_read          = 'minus'
    # MWmix_duration_short         = 0;         delay_between_MWmix       = 0
    ...
    #     velNum = 1; vel_current = 62.7; vel_wvl = 637.22; vel_vpz_target = -1; laserRead_channel = 5
    #     SRSnum  = 1; MWPower  = -5.7; pi_time  = 40; MWFreq  = 2598.44e6; MWPnoOvlap  = -5.7 #NV D1 ms-1
    #     SRSnum3 = 3; MWPower3 = 5.50; pi_time3 = 100; MWFreq3 = 3161.27e6                     #NV D1 ms+1
    #     MWI_channel  = 1; MWQ_channel  = 0; MWswitch_channel  = 2; MWswitch3_channel = 15
    #     SDGnum = 1; AWG_channel = 18; srate = 250000000; amp_MW_mix = 0.7
    #     # NV2
    #     velNum2 = 2; vel_current2 = 67.1; vel_wvl2 = 636.88; vel_vpz_target2=-1; laserRead2_channel = 14
    #     SRSnum2 = 2; MWPower2 = -9.8; pi_time2 = 40; MWFreq2 = 2788.70e6; MWPnoOvlap2 = -9.8 #NV D2 ms-1
    #     SRSnum4 = 4; MWPower4 = 1.00; pi_time4 = 100; MWFreq4 = 3037.20e6                     #NV D2 ms+1
    #     MWI2_channel = 12; MWQ2_channel = 13; MWswitch2_channel = 11; MWswitch4_channel = 16
    #     SDGnum2 = 2; AWG2_channel = 19; srate2 = 250000000; amp_MW_mix2 = 0.7
    # ##############################################################################################################
    # num_loops                    = int(2e3);  nSpinInit                 = 0
    ...
    # laserRead_to_MWmix           = 0;         shift_btwn_2NV_MW         = 80
    # spinInit_RR_duration         = 0;         spinInit_RR_to_pi_delay   = 0*(RRLaserSwitch_delay+200)
    # spinInit_pi_to_RR_delay      = 0;         pi_pulse_bf_read          = 'plus'
    # MWmix_duration_short         = 0;         delay_between_MWmix       = 0
