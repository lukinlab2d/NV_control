...
class Signal(Parameter):
    ...
    def set_raw(self, tcorr):
        ...
        MW_duration_for_AWG2    = int(2*int((AWG_buffer2 + pi2+ rest_after_first_pulse + shift_btwn_2NV_MW + 2*(pi_half2 + last_pi_2time + NXY8*tau_ns*8 + NXY8*pi2*8 + tauExtra) + tcorr)/2))
        ...
        sig_to_ref_wait             = MW_ref_delays[0] - MW_duration_for_AWG - MW_del
        ...
        sig_to_ref_wait2         = MW_ref_delays2[0] - MW_duration_for_AWG2 - MW_del2
        ...
        if self.ifAWG:
            ...
            ch1plot, ch2plot = AWG.send_AutoCorrXY8_seq(mode=self.ifSinDetect, numxy8=NXY8, pi_2time=int(pi_half), 
                                                ...
                                                tauExtra=tauExtra,tcorr=int(tcorr))
