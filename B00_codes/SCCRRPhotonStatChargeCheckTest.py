...
for whichNV in np.linspace(1,2,2):
    ...
    if np.mod(whichNV,2)==1: 
        ...
        SRSnum = 1; MWPower  = -6.2; pi_time  = 40; MWFreq  = 2598.19e6   #NV D1 ms-1 2598.44e6
        SRSnum2= 3; MWPower2 = 6.00; pi_time2 = -1; MWFreq2 = 3161.27e6   #NV D1 ms+1
        MWI_channel  = 1; MWQ_channel  = 0;  MWswitch_channel  = 2; ion_duration= 4e3
    ...
    # tausArray = np.array((1e3,2.5e3,4e3,5.5e3,7e3,8e3))#,10e3,12e3))#,15e3,17.5e3,20e3)) # sweep ti
    # tausArray = np.array((1e6,2e6,3e6,4e6,5e6,6e6,7e6))#,12e6,15e6)) # sweep tr
