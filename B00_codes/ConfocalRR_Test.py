...
ifNeedVel1=0; ifNeedVel2=0; vel_vpz_target=50; vel_vpz_target2=70; hiLoMWPwr_channel=17  
ifNeedSRS=0; ifAWG=0; ifHiloExtra=1

# ConfocalRR
# xArray = np.linspace(0.28, 0.58, 16); yArray = np.linspace(-0.15, 0.15, 16)  
xArray = np.linspace(-0.11, 0.06,18); yArray = np.linspace(-0.36, -0.25, 12)  

num_loops                    = int(2.5e4); settleTime             = 4e6
...
for i in np.linspace(1, reps, reps):
    ...
    SRSnum = 1; MWPower = -6.0; MWI_duration = 40; MWFreq  = 2953.76e6 #2598.44e6      
    ...
    SRSnum2 = 2; MWPower2 = -107; MWI_duration2 = 40; MWFreq2  = 2000.00e6 #2788.70e6 
    ...
    settings = {'xArray': xArray, 'yArray':yArray, 'num_loops':num_loops, 'MWPower':MWPower, 'MWFreq': MWFreq, 'SRSnum': SRSnum,
                'MWPower2':MWPower2, 'MWFreq2': MWFreq2, 'SRSnum2': SRSnum2, 'hiLoMWPwr_channel':      hiLoMWPwr_channel,
                ...
                'ifNeedSRS': ifNeedSRS, 'ifHiloExtra':ifHiloExtra,
