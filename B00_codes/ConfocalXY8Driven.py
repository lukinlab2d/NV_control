...
class ConfocalXY8Driven(Instrument):
    ...
    def __init__(self, name='ConfocalXY8DrivenObject', settings=None, ifPlotPulse=True, **kwargs) -> None:
        ...
        self.SRSnum2=self.settings['SRSnum2']; MWPower2 = self.settings['MWPower2']
...
class Signal(Parameter):
    ...
    def set_raw(self, drive_freq):
        ...
        ch1plot2, ch2plot2 = AWG2.send_DriveUnderXY8_seq(mode = mode, numxy8=numxy8, pi_2time=int(pi2time),
                                                         rest_after_first_pulse=rest_after_first_pulse,
                                            pitime = int(pitime), tau = int(tau_ns),AWGnum=2,
                                            buffer=int(AWG_buffer), sig_to_ref_wait=int(sig_to_ref_wait),
                                            I=I2, Q=Q2)
        ...
        pulse_sequence += [spc.Pulse('AWG2',         AWG_trig_delay,                duration=50)]
