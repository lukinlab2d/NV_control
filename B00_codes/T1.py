...
class Signal(Parameter):
    ...
    def set_raw(self, tau_ns):
        ...
        AFG_delay_after_init_in_ns= self.settings['AFG_delay_after_init_in_ns'];AFG_duration_in_ns         = self.settings['pi_time']; 
        AFG_delay_in_ns = when_init_end + AFG_delay_after_init_in_ns
        
        when_pulse_end = AFG_delay_in_ns + AFG_duration_in_ns
        laser_read_delay_after_pulse_in_ns   = tau_ns;  laser_read_duration_in_ns  = self.settings['laser_read_duration_in_ns']
        read_signal_delay_after_read_laser_on_in_ns  = self.settings['read_signal_delay_after_read_laser_on_in_ns']; read_signal_duration_in_ns = self.settings['read_signal_duration_in_ns']
        read_ref_delay_after_read_laser_on_in_ns     = self.settings['read_ref_delay_after_read_laser_on_in_ns'];     read_ref_duration_in_ns    = self.settings['read_ref_duration_in_ns']
        
        laser_read_delay_in_ns = when_pulse_end + laser_read_delay_after_pulse_in_ns
        read_signal_delay_in_ns = when_pulse_end + tau_ns + read_signal_delay_after_read_laser_on_in_ns
        read_ref_delay_in_ns = when_pulse_end + tau_ns + read_ref_delay_after_read_laser_on_in_ns
