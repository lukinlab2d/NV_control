...
for iii in range(int(1e5)):
    for tr in np.array((2e6,1e6)):
        ...
        laserInit_channel = 3; laserIon_channel = 10; ifInitVpz   = 0; ifInitWvl = 0
        if False: 
        ...
        tausArray = np.round(np.logspace(3,np.log10(10e6),21),-2) # sweep pi_to_ion_delay

        num_loops                    = int(2e3)
        laser_init_delay             = 1e3;       laser_init_duration       = int(1e6)
        laserSwitch_delay_directory  = {3:850, 6:1150, 9:1150, 7:900, 5:1750, 10:120, 14:  0}
        ...
        ion_to_read_delay            = 1.5e6;     DAQ_duration              = tr
        ...
        MWmix_duration_short         = 700;       delay_between_MWmix       = 3e3
        ...
        settings = {'tausArray': tausArray,
                    ...
                    'ifMWReadLowDutyCycle':   ifMWReadLowDutyCycle,    'nMWread':nMWread,
