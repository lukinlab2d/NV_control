...
class SCCROPhotonStatBo(Instrument):

    def __init__(self, name='SCCROPhotonStatBoObject', settings=None, ifPlotPulse=True, **kwargs) -> None:
    ...
    def runScan(self):
        ...
        data = loop.get_data_set(name='SCCROPhotonStatBo')
    ...
    def getDataFilename(self):
        return 'C:/Users/lukin2dmaterials/' + self.data.location + '/SCCROPhotonStatBoObject_sig_set.dat'
