...
class SCCPhotonStat(Instrument):

    def __init__(self, name='SCCPhotonStatObject', settings=None, ifPlotPulse=True, **kwargs) -> None:
    ...
    def runScan(self):
        ...
        data = loop.get_data_set(name='SCCPhotonStat')
    ...
    def getDataFilename(self):
        return 'C:/Users/lukin2dmaterials/' + self.data.location + '/SCCPhotonStatObject_sig_set.dat'
