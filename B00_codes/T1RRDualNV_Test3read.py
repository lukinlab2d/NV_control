...
###########################################################################################e#########################
reps = int(100)
for iii in np.linspace(1,1,reps):
    # T1RRDualNV
    ifRandomized=1; ifPlotPulse=(reps==1); ifNeedVel=0; ifAWG=ifAWG2=ifIQ=ifIQ2=1
    ifFancySpinInit = 0; sweepWhich = 'pi_to_ion_delay'; ifGHzNoise = 0; ifHiloExtra=1
    ...
    if True:
        ...
        SRSnum3 = 3; MWPower3 = -100;  pi_time3 = 40; MWFreq3  = 3161.27e6     #NV D1 ms+1
        ...
        SRSnum4 = 4; MWPower4 = -100; pi_time4 = 40; MWFreq4  = 3037.20e6     #NV D2 ms+1
    ...
    settings = {'tausArray': tausArray,
                ...
                'ifTestSig':ifTestSig, 'ifGHzNoise':ifGHzNoise, 'ifHiloExtra':ifHiloExtra,
                'pi_to_hilo_extra_delay':pi_to_hilo_extra_delay, 'pi_pulse_bf_read':pi_pulse_bf_read,
