...
def main():
    ...
    for i in np.linspace(1,reps,reps):
        xArray = np.linspace(-0.24,-0.20,2); yArray = np.linspace(-1.12,-1.12, 1)
        ...
        pitime                       = 32;       ifShimon               = 0 
        pitime2                      = 32;       BThres = -1000000; BExt = 6948
        laser_to_AWG_delay           = 1e2;      sig_to_ref_delay_Shimon= 1000
        ...
        xref_pitime                  = -0.20;    pi_incr_factor         = 10/0.12; pi_incr_factor2=49/0.72 #ns/Vx
        MW_to_read_delay             = 100;      AWG_delay              = AWG_output_delay

        MWfreqDictFile='C:/Users/lukin2dmaterials/data/2025-09-22/#019_ConfocalODMRAWGFast_22-34-38/MWfreqDict_20K.pkl'
        MWfreqDictFilePlus='C:/Users/lukin2dmaterials/data/2025-09-22/#019_ConfocalODMRAWGFast_22-34-38/MWfreqDictPlus_20K.pkl'
