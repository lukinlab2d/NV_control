...
class ConfocalT2RAWGFast(Instrument):

    def __init__(self, name='ConfocalT2RAWGFastObject', settings=None, ifPlotPulse=True, **kwargs) -> None:
        ...
        self.galvo = DAQAnalogOutputs("ConfocalT2RAWGFastDAQ", galvo_card_name, galvo_ao_channels)
    ...
    def runScan(self):
        ...
        data = loopy.get_data_set(name='ConfocalT2RAWGFast')
    ...
    def getDataFilename(self):
        return 'C:/Users/lukin2dmaterials/' + self.data.location + '/ConfocalT2RAWGFastObject_sig_set.dat'
