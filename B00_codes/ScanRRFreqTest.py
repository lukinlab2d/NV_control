...
for iii in np.linspace(637, 636, 1):
    # Test for ScanRRFreq
    if False:
        velNum = 1; vel_current = 62.7; vel_wvl = 637.25; laserRead_channel = 5
        SRSnum = 1; MWPower = 0; MW_duration = 70; MWFreq  = 3862e6   #NV D1 2953.76e6
        SDGnum = 1; AWG_channel = 18; MWswitch_channel = 2
        start = 63; stop = 72; num_sweep_points = int(9*12+1) # slow scan
    else:
        velNum = 2; vel_current = 67; vel_wvl = 636.94; laserRead_channel = 14
        ...
        SRSnum = 1; MWPower = 0; MW_duration = 54; MWFreq  = 2882e6   #NV D1 2953.76e6
        SDGnum = 1; AWG_channel = 18; MWswitch_channel = 2
        start = 2; stop = 99; num_sweep_points = int(97*10+1) # slow scan
    vpzArray = np.linspace(start, stop, num_sweep_points)

    num_loops                    = int(2e5);   ifInitVpz = 0
    laser_init_delay             = 5e2;        laser_init_duration    = 4e3
    ...
    settings = {'vpzArray': vpzArray,    'num_loops':num_loops,  'MWPower':MWPower,    'MWFreq': MWFreq,
                ...
                'MWswitch_channel': MWswitch_channel,
